...
<div class="container mx-auto px-4">
	<div class="grid grid-cols-12 gap-y-[40px] lg:gap-y-0 lg:gap-x-[40px] lg:min-h-[80vh] mb-[30px] lg:mb-0">
		...
		@if($loop->iteration === 4)
		<div class="col-span-12 lg:col-span-3 flex flex-col items-center lg:items-start justify-end">
			<div class="flex flex-col items-start justify-between h-[50vh]">
				@foreach($service->items as $item)
				<div class="font-primary font-normal tracking-wider leading-tight text-[27px] text-primary-grey">
					{!! nl2br($item['name']) !!}
				</div>
				@endforeach
			</div>
